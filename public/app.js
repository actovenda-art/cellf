...
const seed = {
  products: [
    { id: 'prd-carregador-iphone', sku: 'CAR-IPH-TC-LG', name: 'Carregador iPhone tipo C/Lightning', category: 'Carregadores', cost: 20, price: 40, stock: 0, minimum: 0 },
    { id: 'prd-cabo-lightning-2m', sku: 'CAB-LGT-2M', name: 'Cabo Lightning 2M', category: 'Cabos', cost: 13, price: 35, stock: 0, minimum: 0 },
    { id: 'prd-cabo-fita', sku: 'CAB-FITA-TC-LG', name: 'Cabo fita tipo C/Lightning', category: 'Cabos', cost: 14, price: 35, stock: 0, minimum: 0 },
    { id: 'prd-pelicula-xr', sku: 'PEL-IPXR-3D', name: 'Película iPhone XR 3D Vidro', category: 'Películas', cost: 2, price: 35, stock: 0, minimum: 0 },
    { id: 'prd-chip-tim', sku: 'CHIP-TIM', name: 'Chip Tim', category: 'Telefonia', cost: 10, price: 25, stock: 0, minimum: 0 },
    { id: 'prd-pelicula-g84', sku: 'PEL-G84-3D', name: 'Película G84 Vidro 3D', category: 'Películas', cost: 2, price: 20, stock: 0, minimum: 0 },
    { id: 'prd-carregador-gold', sku: 'CAR-TC-GOLD', name: 'Carregador tipo C Gold', category: 'Carregadores', cost: 23, price: 49, stock: 0, minimum: 0 },
    { id: 'prd-pelicula-g62', sku: 'PEL-G62', name: 'Película G62 Tela', category: 'Películas', cost: 0, price: 20, stock: 0, minimum: 0 },
    { id: 'prd-pelicula-a05s', sku: 'PEL-A05S', name: 'Película A05s', category: 'Películas', cost: 0, price: 0, stock: 0, minimum: 0 },
    { id: 'prd-gaveta-g8', sku: 'GAV-CHIP-G8P', name: 'Gaveta Chip G8+', category: 'Peças', cost: 20, price: 35, stock: 0, minimum: 0 },
    { id: 'prd-suporte-veicular', sku: 'SUP-VEIC', name: 'Suporte veicular', category: 'Acessórios', cost: 15, price: 40, stock: 0, minimum: 0 },
    { id: 'prd-pendrive-16gb', sku: 'PEN-16GB', name: 'Pendrive 16GB', category: 'Armazenamento', cost: 0, price: 20, stock: 0, minimum: 0 }
  ],
  services: [
    { id: 'srv-g84-tela', name: 'Conserto G84 Tela', category: 'Tela', pricing: 'fixed', price: 280, cost: 0, duration: null, active: true },
    { id: 'srv-g62-tela', name: 'Conserto G62 Tela', category: 'Tela', pricing: 'fixed', price: 330, cost: 128, duration: null, active: true },
    { id: 'srv-iphone-xr-bateria', name: 'Conserto iPhone XR Bateria', category: 'Bateria', pricing: 'fixed', price: 190, cost: 94, duration: null, active: true },
    { id: 'srv-a05s-tela', name: 'Conserto A05s Tela', category: 'Tela', pricing: 'fixed', price: 280, cost: 103, duration: null, active: true },
    { id: 'srv-iphone-limpeza-conector', name: 'Conserto iPhone Limpeza Conector', category: 'Conector', pricing: 'fixed', price: 60, cost: 12, duration: null, active: true },
    { id: 'srv-g8-gaveta-chip', name: 'Reparo G8+ Gaveta Chip', category: 'Peças', pricing: 'fixed', price: 20, cost: 0, duration: null, active: true }
  ],
  orders: [
    { id: 'OS-20260912-01', customerId: '', customer: ANONYMOUS_CUSTOMER, phone: '', device: 'Moto G84', imei: '', issue: 'Conserto de tela', serviceId: 'srv-g84-tela', serviceCost: 0, value: 280, payment: 'pix', paymentDetails: 'Pix', status: 'delivered', createdAt: '2026-09-12', dueAt: '2026-09-12', deliveredAt: '2026-09-12T12:00:00-03:00', attendanceType: 'in_store_service', reminderAt: '', reminder: '' },
    { id: 'OS-20260915-01', customerId: '', customer: ANONYMOUS_CUSTOMER, phone: '', device: 'Moto G62', imei: '', issue: 'Conserto de tela', serviceId: 'srv-g62-tela', serviceCost: 128, value: 330, payment: 'cash', paymentDetails: 'Dinheiro', status: 'delivered', createdAt: '2026-09-15', dueAt: '2026-09-15', deliveredAt: '2026-09-15T12:00:00-03:00', attendanceType: 'in_store_service', reminderAt: '', reminder: '' },
    { id: 'OS-20260916-01', customerId: '', customer: ANONYMOUS_CUSTOMER, phone: '', device: 'iPhone XR', imei: '', issue: 'Troca de bateria', serviceId: 'srv-iphone-xr-bateria', serviceCost: 94, value: 190, payment: 'credit', paymentDetails: 'Crédito 3x', status: 'delivered', createdAt: '2026-09-16', dueAt: '2026-09-16', deliveredAt: '2026-09-16T12:00:00-03:00', attendanceType: 'in_store_service', reminderAt: '', reminder: '' },
    { id: 'OS-20260916-02', customerId: '', customer: ANONYMOUS_CUSTOMER, phone: '', device: 'Samsung A05s', imei: '', issue: 'Conserto de tela', serviceId: 'srv-a05s-tela', serviceCost: 103, value: 280, payment: 'debit', paymentDetails: 'Débito', status: 'delivered', createdAt: '2026-09-16', dueAt: '2026-09-16', deliveredAt: '2026-09-16T13:00:00-03:00', attendanceType: 'in_store_service', reminderAt: '', reminder: '' },
    { id: 'OS-20260916-03', customerId: '', customer: ANONYMOUS_CUSTOMER, phone: '', device: 'iPhone', imei: '', issue: 'Limpeza do conector', serviceId: 'srv-iphone-limpeza-conector', serviceCost: 12, value: 60, payment: 'cash', paymentDetails: 'Dinheiro', status: 'delivered', createdAt: '2026-09-16', dueAt: '2026-09-16', deliveredAt: '2026-09-16T14:00:00-03:00', attendanceType: 'in_store_service', reminderAt: '', reminder: '' },
    { id: 'OS-20260917-01', customerId: '', customer: ANONYMOUS_CUSTOMER, phone: '', device: 'Moto G8+', imei: '', issue: 'Reparo da gaveta do chip', serviceId: 'srv-g8-gaveta-chip', serviceCost: 0, value: 20, payment: 'pix', paymentDetails: 'Pix', status: 'delivered', createdAt: '2026-09-17', dueAt: '2026-09-17', deliveredAt: '2026-09-17T12:00:00-03:00', attendanceType: 'in_store_service', reminderAt: '', reminder: '' }
  ],
  payables: [
    { id: 'fix-alimentacao', description: 'Alimentação', supplier: 'Não informado', category: 'Despesa fixa', amount: 756, dueAt: '2026-09-01', paid: false },
    { id: 'fix-aluguel', description: 'Aluguel', supplier: 'Não informado', category: 'Despesa fixa', amount: 1950, dueAt: '2026-09-10', paid: false },
    { id: 'fix-internet', description: 'Internet', supplier: 'Não informado', category: 'Despesa fixa', amount: 110, dueAt: '2026-09-10', paid: false },
    { id: 'fix-dae', description: 'DAE', supplier: 'Não informado', category: 'Despesa fixa', amount: 180, dueAt: '2026-09-25', paid: false },
    { id: 'fix-cpfl', description: 'CPFL', supplier: 'Não informado', category: 'Despesa fixa', amount: 100, dueAt: '2026-09-25', paid: false }
  ],
  customers: [],
  sales: [
    { id: 'v-20260910-01', customerId: '', customer: ANONYMOUS_CUSTOMER, customerDocument: '', customerPhone: '', items: [{ productId: 'prd-carregador-iphone', name: 'Carregador iPhone tipo C/Lightning', sku: 'CAR-IPH-TC-LG', quantity: 1, unitPrice: 40, cost: 20 }], subtotal: 40, discount: 0, total: 40, payment: 'pix', paymentDetails: 'Pix', attendanceType: 'counter_sale', deliveryAddress: null, status: 'paid', createdAt: '2026-09-10T12:00:00-03:00' },
    { id: 'v-20260910-02', customerId: '', customer: ANONYMOUS_CUSTOMER, customerDocument: '', customerPhone: '', items: [{ productId: 'prd-cabo-lightning-2m', name: 'Cabo Lightning 2M', sku: 'CAB-LGT-2M', quantity: 1, unitPrice: 35, cost: 13 }], subtotal: 35, discount: 0, total: 35, payment: 'pix', paymentDetails: 'Pix', attendanceType: 'counter_sale', deliveryAddress: null, status: 'paid', createdAt: '2026-09-10T12:05:00-03:00' },
    { id: 'v-20260911-01', customerId: '', customer: ANONYMOUS_CUSTOMER, customerDocument: '', customerPhone: '', items: [{ productId: 'prd-cabo-fita', name: 'Cabo fita tipo C/Lightning', sku: 'CAB-FITA-TC-LG', quantity: 1, unitPrice: 35, cost: 14 }], subtotal: 35, discount: 0, total: 35, payment: 'pix', paymentDetails: 'Pix', attendanceType: 'counter_sale', deliveryAddress: null, status: 'paid', createdAt: '2026-09-11T12:00:00-03:00' },
    { id: 'v-20260911-02', customerId: '', customer: ANONYMOUS_CUSTOMER, customerDocument: '', customerPhone: '', items: [{ productId: 'prd-pelicula-xr', name: 'Película iPhone XR 3D Vidro', sku: 'PEL-IPXR-3D', quantity: 1, unitPrice: 35, cost: 2 }], subtotal: 35, discount: 0, total: 35, payment: 'pix', paymentDetails: 'Pix', attendanceType: 'counter_sale', deliveryAddress: null, status: 'paid', createdAt: '2026-09-11T12:05:00-03:00' },
    { id: 'v-20260911-03', customerId: '', customer: ANONYMOUS_CUSTOMER, customerDocument: '', customerPhone: '', items: [{ productId: 'prd-chip-tim', name: 'Chip Tim', sku: 'CHIP-TIM', quantity: 1, unitPrice: 25, cost: 10 }], subtotal: 25, discount: 0, total: 25, payment: 'debit', paymentDetails: 'Débito', attendanceType: 'counter_sale', deliveryAddress: null, status: 'paid', createdAt: '2026-09-11T12:10:00-03:00' },
    { id: 'v-20260912-01', customerId: '', customer: ANONYMOUS_CUSTOMER, customerDocument: '', customerPhone: '', items: [{ productId: 'prd-pelicula-g84', name: 'Película G84 Vidro 3D', sku: 'PEL-G84-3D', quantity: 1, unitPrice: 20, cost: 2 }], subtotal: 20, discount: 0, total: 20, payment: 'pix', paymentDetails: 'Pix', attendanceType: 'counter_sale', deliveryAddress: null, status: 'paid', createdAt: '2026-09-12T12:05:00-03:00' },
    { id: 'v-20260914-01', customerId: '', customer: ANONYMOUS_CUSTOMER, customerDocument: '', customerPhone: '', items: [{ productId: 'prd-carregador-gold', name: 'Carregador tipo C Gold', sku: 'CAR-TC-GOLD', quantity: 1, unitPrice: 49, cost: 23 }], subtotal: 49, discount: 0, total: 49, payment: 'debit', paymentDetails: 'Débito', attendanceType: 'counter_sale', deliveryAddress: null, status: 'paid', createdAt: '2026-09-14T12:00:00-03:00' },
    { id: 'v-20260915-01', customerId: '', customer: ANONYMOUS_CUSTOMER, customerDocument: '', customerPhone: '', items: [{ productId: 'prd-pelicula-g62', name: 'Película G62 Tela', sku: 'PEL-G62', quantity: 1, unitPrice: 20, cost: 0 }], subtotal: 20, discount: 0, total: 20, payment: 'cash', paymentDetails: 'Dinheiro', attendanceType: 'counter_sale', deliveryAddress: null, status: 'paid', createdAt: '2026-09-15T12:05:00-03:00' },
    { id: 'v-20260916-01', customerId: '', customer: ANONYMOUS_CUSTOMER, customerDocument: '', customerPhone: '', items: [{ productId: 'prd-pelicula-a05s', name: 'Película A05s', sku: 'PEL-A05S', quantity: 1, unitPrice: 0, cost: 0 }], subtotal: 0, discount: 0, total: 0, payment: 'pix', paymentDetails: 'Pix', attendanceType: 'counter_sale', deliveryAddress: null, status: 'paid', createdAt: '2026-09-16T13:05:00-03:00' },
    { id: 'v-20260917-01', customerId: '', customer: ANONYMOUS_CUSTOMER, customerDocument: '', customerPhone: '', items: [{ productId: 'prd-gaveta-g8', name: 'Gaveta Chip G8+', sku: 'GAV-CHIP-G8P', quantity: 1, unitPrice: 35, cost: 20 }], subtotal: 35, discount: 0, total: 35, payment: 'pix', paymentDetails: 'Pix', attendanceType: 'counter_sale', deliveryAddress: null, status: 'paid', createdAt: '2026-09-17T12:05:00-03:00' },
    { id: 'v-20260917-02', customerId: '', customer: ANONYMOUS_CUSTOMER, customerDocument: '', customerPhone: '', items: [{ productId: 'prd-suporte-veicular', name: 'Suporte veicular', sku: 'SUP-VEIC', quantity: 1, unitPrice: 40, cost: 15 }], subtotal: 40, discount: 0, total: 40, payment: 'pix', paymentDetails: 'Pix', attendanceType: 'counter_sale', deliveryAddress: null, status: 'paid', createdAt: '2026-09-17T12:10:00-03:00' },
    { id: 'v-20260917-03', customerId: '', customer: ANONYMOUS_CUSTOMER, customerDocument: '', customerPhone: '', items: [{ productId: 'prd-pendrive-16gb', name: 'Pendrive 16GB', sku: 'PEN-16GB', quantity: 1, unitPrice: 20, cost: 0 }], subtotal: 20, discount: 0, total: 20, payment: 'debit', paymentDetails: 'Débito', attendanceType: 'counter_sale', deliveryAddress: null, status: 'paid', createdAt: '2026-09-17T12:15:00-03:00' },
    { id: 'v-20260917-04', customerId: '', customer: ANONYMOUS_CUSTOMER, customerDocument: '', customerPhone: '', items: [{ productId: 'prd-chip-tim', name: 'Chip Tim', sku: 'CHIP-TIM', quantity: 1, unitPrice: 25, cost: 10 }], subtotal: 25, discount: 0, total: 25, payment: 'debit', paymentDetails: 'Débito', attendanceType: 'counter_sale', deliveryAddress: null, status: 'paid', createdAt: '2026-09-17T12:20:00-03:00' }
  ],
  deliveries: [],
  appointments: [],
  stockMovements: [],
  ...
  issuedDocuments: [],
  companyDocuments: [],
  operationalDataVersion: OPERATIONAL_DATA_VERSION,
  settings: {
    companyName: 'Cellf',
...
function loadState(source = null, { applyOperationalImport = false } = {}) {
  ...
  try {
    const storedSource = source && typeof source === 'object' && !Array.isArray(source)
      ? source
      : fallback;
    const sourceState = storedSource && typeof storedSource === 'object' && !Array.isArray(storedSource) ? storedSource : fallback;
    const stored = applyOperationalImport && sourceState.operationalDataVersion !== OPERATIONAL_DATA_VERSION
      ? {
          ...sourceState,
          products: structuredClone(seed.products),
          services: structuredClone(seed.services),
          orders: structuredClone(seed.orders),
          payables: structuredClone(seed.payables),
          customers: [],
    ...
    const migrated = {
      ...
      orders: (Array.isArray(stored.orders) ? stored.orders : structuredClone(seed.orders)).map(order => ({
        ...
        partsReserved: Boolean(order.partsReserved)
      })),
    ...
    migrated.orders.forEach(order => {
      ...
      if (!customer && order.customer && normalize(order.customer) !== normalize(ANONYMOUS_CUSTOMER)) {
        customer = {
      ...
      if (!customer && normalize(order.customer) === normalize(ANONYMOUS_CUSTOMER)) order.customerId = '';
    });
...
function normalizeAddress(address = {}, fallbackId = '') {
  ...
  return {
    ...
    region: String(source.region || source.state || source.uf || '').trim().toUpperCase().slice(0, 2),
    reference: String(source.reference || source.referencia || '').trim(),
...
function formatAddress(address, { compact = false } = {}) {
  ...
  const location = [address.neighborhood, [address.city, address.region].filter(Boolean).join(' / ')].filter(Boolean).join(' · ');
  return [line, address.complement, location, compact ? '' : address.postalCode ? `CEP ${formatPostalCode(address.postalCode)}` : ''].filter(Boolean).join(' · ');
}
function validateAddress(address) {
  if (String(address.postalCode || '').replace(/\D/g, '').length !== 8) return 'Informe um CEP válido com oito números.';
  if (!address.street) return 'Informe a rua ou avenida do endereço.';
  if (!address.number) return 'Informe o número do endereço ou “S/N”.';
  if (!address.neighborhood) return 'Informe o bairro do endereço.';
  if (!address.city) return 'Informe a cidade do endereço.';
  if (!/^[A-Z]{2}$/.test(address.region || '')) return 'Informe a UF do endereço com duas letras.';
  return '';
}
...
function createDeliveryRecord({ sourceType, sourceId, kind, customer, address, scheduledDate }) {
  return {
    ...
    address: { ...address },
    scheduledDate: scheduledDate || isoToday(),
    status: 'scheduled',
    createdAt: new Date().toISOString(),
    completedAt: ''
  };
}
function syncRepairDeliveries(order, customer, address) {
  const existing = state.deliveries.filter(delivery => delivery.sourceType === 'order' && delivery.sourceId === order.id);
  if (order.attendanceType !== 'pickup_return' || order.status === 'cancelled') {
    existing.filter(delivery => !['completed', 'cancelled'].includes(delivery.status)).forEach(delivery => { delivery.status = 'cancelled'; });
    return;
  }
  for (const [kind, scheduledDate] of [['repair_pickup', order.createdAt], ['repair_return', order.dueAt]]) {
    const delivery = existing.find(item => item.kind === kind && item.status !== 'cancelled');
    if (delivery) {
    ...
    } else state.deliveries.unshift(createDeliveryRecord({ sourceType: 'order', sourceId: order.id, kind, customer, address, scheduledDate }));
  }
}
function completeOrderDeliveries(order) {
  if (order.attendanceType !== 'pickup_return') return;
  state.deliveries.filter(delivery => delivery.sourceType === 'order' && delivery.sourceId === order.id && delivery.status !== 'cancelled').forEach(delivery => {
...
function updateOrderPartReservation(order, nextParts, shouldReserve, sourceId = order.id || 'Nova ordem') {
  const previousReserved = order.partsReserved ? orderParts(order) : [];
  const nextReserved = shouldReserve ? nextParts : [];
  const previousById = new Map(previousReserved.map(part => [part.productId, Number(part.quantity || 0)]));
  const nextById = new Map(nextReserved.map(part => [part.productId, Number(part.quantity || 0)]));
  for (const product of state.products) {
    const delta = Number(nextById.get(product.id) || 0) - Number(previousById.get(product.id) || 0);
    if (delta > Number(product.stock || 0)) return `Estoque insuficiente de ${product.name}. Disponível: ${product.stock}.`;
  }
  for (const product of state.products) {
    const delta = Number(nextById.get(product.id) || 0) - Number(previousById.get(product.id) || 0);
    if (delta) {
      product.stock = Number(product.stock || 0) - delta;
      state.stockMovements.unshift({ id: uid('mov'), productId: product.id, productName: product.name, type: delta > 0 ? 'out' : 'in', quantity: Math.abs(delta), reason: `${delta > 0 ? 'Reserva' : 'Devolução'} de peça · ${sourceId}`, createdAt: new Date().toISOString() });
    }
  }
  state.stockMovements = state.stockMovements.slice(0, 200);
  return '';
}
function paymentLabel(record = {}) { return record.paymentDetails || PAYMENT_LABELS[record.payment] || record.payment || 'Não informado'; }
...
function renderServices() {
  ...
  const timed = active.filter(service => Number(service.duration) > 0);
  ...
  <div class="summary-strip insight-grid">${statCard('SERVIÇOS ATIVOS', active.length, '⌁', `${state.services.length - active.length} inativos`)}${statCard('PREÇO MÉDIO', fixed.length ? brl.format(sum(fixed, 'price') / fixed.length) : '—', '↗', `${fixed.length} com preço fixo`)}${statCard('DURAÇÃO MÉDIA', timed.length ? `${Math.round(sum(timed, 'duration') / timed.length)} min` : '—', '◷', timed.length ? 'Tempo estimado de atendimento' : 'Não informada na planilha')}${statCard('CATEGORIAS', new Set(active.map(service => service.category)).size, '◇', 'Especialidades disponíveis')}</div>
...
function renderDeliveries() {
  const active = state.deliveries.filter(delivery => !['completed', 'cancelled'].includes(delivery.status));
...
function deliveryRows(list) {
  return `<thead><tr><th>MOVIMENTAÇÃO</th><th>CLIENTE</th><th>ENDEREÇO</th><th>PREVISÃO</th><th>STATUS</th><th><span class="sr-only">Ações</span></th></tr></thead><tbody>${list.length ? list.map(delivery => `<tr><td><div class="cell-main"><span class="product-thumb">${delivery.kind === 'repair_pickup' ? '↥' : '↗'}</span><span><strong>${esc(DELIVERY_KIND_LABELS[delivery.kind] || 'Entrega')}</strong><small>${esc(String(delivery.sourceId || '').toUpperCase())}</small></span></div></td><td><strong>${esc(delivery.customer)}</strong><br><small>${esc(delivery.phone || 'Sem telefone')}</small></td><td><span class="delivery-address-cell">${esc(formatAddress(delivery.address, { compact: true }) || 'Endereço não informado')}</span></td><td>${formatDate(delivery.scheduledDate)}</td><td><select class="inline-status delivery-status-select" data-action="delivery-status" data-id="${esc(delivery.id)}" aria-label="Status da movimentação de ${esc(delivery.customer)}">${Object.entries(DELIVERY_STATUS_LABELS).map(([value, label]) => `<option value="${value}" ${delivery.status === value ? 'selected' : ''}>${label}</option>`).join('')}</select></td><td><button class="more-button" data-action="view-delivery" data-id="${esc(delivery.id)}" aria-label="Ver movimentação de ${esc(delivery.customer)}">•••</button></td></tr>`).join('') : '<tr><td colspan="6"><div class="table-empty">Nenhuma entrega ou busca e leva registrada.</div></td></tr>'}</tbody>`;
}
function deliveryMobile(list) {
  return list.map(delivery => `<article class="mobile-card delivery-mobile-card"><div class="mobile-card-top"><div><strong>${esc(delivery.customer)}</strong><small>${esc(DELIVERY_KIND_LABELS[delivery.kind] || 'Entrega')} · ${formatDate(delivery.scheduledDate)}</small></div><button class="more-button" data-action="view-delivery" data-id="${esc(delivery.id)}" aria-label="Ver entrega">•••</button></div><p class="delivery-mobile-address">${esc(formatAddress(delivery.address, { compact: true }))}</p><div class="mobile-card-bottom"><span class="status ${deliveryStatusClass(delivery.status)}">${esc(DELIVERY_STATUS_LABELS[delivery.status] || delivery.status)}</span><strong>${esc(String(delivery.sourceId || '').toUpperCase())}</strong></div></article>`).join('');
}
...
function bindTableFilter(type) {
  ...
  const update = () => {
    ...
    const renderers = { products:[productRows,productMobile], services:[serviceRows,serviceMobile], orders:[orderRows,orderMobile], payables:[payableRows,payableMobile], customers:[customerRows,customerMobile], deliveries:[deliveryRows,deliveryMobile] }[type];
...
function agendaEvents(date) {
  ...
  const deliveries = state.orders.filter(order => order.dueAt === date && !['delivered', 'cancelled'].includes(order.status) && order.attendanceType !== 'pickup_return').map(order => ({
    id: order.id,
  ...
  const logistics = state.deliveries.filter(delivery => delivery.scheduledDate === date && !['completed', 'cancelled'].includes(delivery.status)).map(delivery => ({
    id: delivery.id,
    title: DELIVERY_KIND_LABELS[delivery.kind] || 'Entrega',
    subtitle: `${delivery.customer} · ${formatAddress(delivery.address, { compact: true })}`,
    time: delivery.kind === 'repair_pickup' ? state.settings.openingTime || '09:00' : state.settings.closingTime || '18:00',
    type: 'delivery',
  ...
  return [...scheduled, ...deliveries, ...logistics, ...reminders, ...payables].sort((a, b) => a.time.localeCompare(b.time));
}
...
function renderAgenda() {
  ...
  const monthDeliveries = [...state.orders.filter(order => order.dueAt?.startsWith(monthPrefix) && !['delivered', 'cancelled'].includes(order.status) && order.attendanceType !== 'pickup_return'), ...state.deliveries.filter(delivery => delivery.scheduledDate?.startsWith(monthPrefix) && !['completed', 'cancelled'].includes(delivery.status))];
...
function renderReports() {
  ...
  const paymentTotals = Object.entries(PAYMENT_LABELS).map(([key, label]) => {
    const matchingSales = data.sales.filter(sale => sale.payment === key);
    const matchingServices = data.delivered.filter(order => order.payment === key);
    return { label, amount: sum(matchingSales, 'total') + sum(matchingServices, 'value'), count: matchingSales.length + matchingServices.length };
  ...
  content.innerHTML = `${pageHeading('INTELIGÊNCIA DO NEGÓCIO', 'Relatórios e resultados', 'Entenda o desempenho da loja com dados reais da operação.', '<button class="ghost-button" data-action="export-report">↓ Exportar relatório</button>')}
    ...
    <section class="card report-section"><header class="card-header"><div><p class="eyebrow">PAGAMENTOS</p><h2>Como seus clientes pagam</h2></div></header>${renderBreakdown(paymentTotals, data.revenue, 'Nenhuma venda no período', 'As formas de pagamento aparecerão após as primeiras vendas.')}</section>
...
function customerModal(customer = {}) {
  ...
  document.querySelector('#customer-form').addEventListener('submit', event => {
    ...
    if (customer.id) {
      ...
      state.deliveries.filter(delivery => delivery.customerId === customer.id).forEach(delivery => { delivery.customer = record.name; delivery.phone = record.phone; });
...
function orderModal(order = {}) {
  ...
  const partsMarkup = state.products.map(product => {
    ...
    const available = Number(product.stock || 0) + (order.partsReserved ? Number(selected?.quantity || 0) : 0);
    return `<div class="order-part-item"><label><input type="checkbox" name="part-${esc(product.id)}" data-order-part="${esc(product.id)}" ${selected ? 'checked' : ''} ${!selected && available <= 0 ? 'disabled' : ''}><span><strong>${esc(product.name)}</strong><small>${esc(product.sku)} · ${available} disponível</small></span></label><input type="number" name="partQty-${esc(product.id)}" data-order-part-quantity="${esc(product.id)}" min="1" max="${available}" value="${Number(selected?.quantity || 1)}" ${selected ? '' : 'disabled'} aria-label="Quantidade de ${esc(product.name)}"></div>`;
  }).join('');
  ...
  const toggleAddress = () => {
    ...
    for (const name of ['postalCode', 'street', 'number', 'neighborhood', 'city', 'region']) {
  ...
  form.querySelectorAll('[data-order-part]').forEach(checkbox => checkbox.addEventListener('change', () => {
    const quantity = form.querySelector(`[data-order-part-quantity="${checkbox.dataset.orderPart}"]`);
  ...
  document.querySelector('#order-form').addEventListener('submit', event => {
    ...
    const parts = state.products.filter(product => formData.has(`part-${product.id}`)).map(product => ({
      productId: product.id,
      name: product.name,
      sku: product.sku,
      quantity: Math.max(1, Number(formData.get(`partQty-${product.id}`) || 1)),
      cost: Number(product.cost || 0)
    }));
    const quoteStatus = Object.hasOwn(QUOTE_STATUS_LABELS, data.quoteStatus) ? data.quoteStatus : 'pending';
    const shouldReserveParts = quoteStatus === 'approved' && !['cancelled'].includes(order.id ? data.status : 'analysis');
    const reservationError = updateOrderPartReservation(order, parts, shouldReserveParts, order.id || `OS-${next}`);
    if (reservationError) return toast(reservationError, 'error');
    const anonymousCustomer = normalize(data.customer) === normalize(ANONYMOUS_CUSTOMER);
    ...
    if (record.status === 'delivered') completeOrderDeliveries(record);
...
function viewDelivery(delivery) {
  ...
  const digits = String(delivery.phone || '').replace(/\D/g, '');
  openModal(DELIVERY_KIND_LABELS[delivery.kind] || 'Movimentação', 'LOGÍSTICA E ENDEREÇO', `<div class="delivery-detail"><div class="delivery-detail-heading"><div><strong>${esc(delivery.customer)}</strong><p>${esc(String(delivery.sourceId || '').toUpperCase())}</p></div><span class="status ${deliveryStatusClass(delivery.status)}">${esc(DELIVERY_STATUS_LABELS[delivery.status] || delivery.status)}</span></div><div class="detail-grid"><div class="field"><label>TIPO DE MOVIMENTAÇÃO</label><strong>${esc(DELIVERY_KIND_LABELS[delivery.kind] || 'Entrega')}</strong></div><div class="field"><label>DATA PREVISTA</label><strong>${formatDate(delivery.scheduledDate)}</strong></div><div class="field"><label>TELEFONE / WHATSAPP</label><strong>${esc(delivery.phone || 'Não informado')}</strong></div><div class="field"><label>ORIGEM</label><strong>${delivery.sourceType === 'order' ? 'Ordem de serviço' : 'Venda de produtos'}</strong></div></div><div class="detail-section address-detail-section"><h3>${esc(delivery.address?.label || 'Endereço')}</h3><p>${esc(address)}</p>${delivery.address?.reference ? `<small>Referência: ${esc(delivery.address.reference)}</small>` : ''}</div><div class="form-actions">${digits ? `<a class="ghost-button" href="https://wa.me/55${esc(digits)}" target="_blank" rel="noopener noreferrer">WhatsApp ↗</a>` : ''}<a class="ghost-button" href="${esc(mapUrl)}" target="_blank" rel="noopener noreferrer">Abrir rota ↗</a>${!['completed', 'cancelled'].includes(delivery.status) ? `<button class="primary-button" data-action="advance-delivery" data-id="${esc(delivery.id)}">${delivery.status === 'scheduled' ? 'Iniciar deslocamento' : '✓ Concluir movimentação'}</button>` : ''}</div></div>`);
}
...
function commandSearch(query) {
  ...
  const shortcuts = [
    ...
    { kind: 'Tela', title: 'Entregas e busca e leva', sub: 'Endereços, coletas e entregas de compras', view: 'deliveries' },
...
function refreshBadges() {
  ...
  const deliveryCount = document.querySelector('#nav-deliveries-count');
  if (deliveryCount) deliveryCount.textContent = state.deliveries.filter(delivery => !['completed', 'cancelled'].includes(delivery.status)).length;
    ...
    <div class="cellf-public-header-stack">
      <header class="cellf-public-header">
        <div class="cellf-public-glass-transition" aria-hidden="true">
          <div class="cellf-distorted-glass"><span></span><img class="cellf-glass-texture" src="/cellf-distorted-glass.svg?v=2" alt="" width="1200" height="120"></div>
...
document.addEventListener('click', event => {
  ...
  switch (action) {
    ...
    case 'deliver-order': {
      ...
      if (!order) break;
      const reservationError = updateOrderPartReservation(order, orderParts(order), true);
      if (reservationError) { toast(reservationError, 'error'); break; }
    ...
    case 'advance-delivery': {
      ...
      if (!delivery || ['completed', 'cancelled'].includes(delivery.status)) break;
      delivery.status = delivery.status === 'scheduled' ? 'in_transit' : 'completed';
      delivery.completedAt = delivery.status === 'completed' ? new Date().toISOString() : '';
      recordActivity('delivery', `${DELIVERY_KIND_LABELS[delivery.kind]}: ${DELIVERY_STATUS_LABELS[delivery.status]} · ${delivery.customer}`);
      saveState(); closeModal(); navigate('deliveries'); toast(delivery.status === 'completed' ? 'Movimentação concluída.' : 'Deslocamento iniciado.');
      break;
    }
...
document.addEventListener('change', event => {
  ...
  if (event.target.matches('[data-action="order-status"]')) {
    ...
    const advancesWork = ['approved', 'progress', 'ready', 'delivered'].includes(nextStatus);
    const shouldReserveParts = nextStatus !== 'cancelled' && (order.quoteStatus === 'approved' || advancesWork);
    const reservationError = updateOrderPartReservation(order, orderParts(order), shouldReserveParts);
    if (reservationError) { toast(reservationError, 'error'); navigate('orders'); return; }
    order.partsReserved = shouldReserveParts;
    order.status = nextStatus;
    if (advancesWork && order.quoteStatus === 'pending') {
      order.quoteStatus = 'approved';
      order.quoteDecidedAt ||= new Date().toISOString();
    }
    if (order.status === 'cancelled' && order.quoteStatus === 'pending') order.quoteStatus = 'rejected';
  ...
  if (event.target.matches('[data-action="delivery-status"]')) {
    ...
    if (!delivery || !Object.hasOwn(DELIVERY_STATUS_LABELS, event.target.value)) return;
    delivery.status = event.target.value;
    delivery.completedAt = delivery.status === 'completed' ? delivery.completedAt || new Date().toISOString() : '';
    recordActivity('delivery', `${DELIVERY_KIND_LABELS[delivery.kind]}: ${DELIVERY_STATUS_LABELS[delivery.status]} · ${delivery.customer}`);
    saveState(); navigate('deliveries'); toast('Status da movimentação atualizado.');
  }
});
